<template>
  <div class="chrray-main">
    <van-cell class="chrray-cell">
      <h1 class="cell-title">{{ pageInfo.trainProjectName }}</h1>
    ...
    <div class="chrray-html" v-html="pageInfo.trainProjectContext"></div>
...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      api.trainDelit(params).then(res => {
        that.pageInfo = res.data
        let shareData = {
          title: res.data.trainProjectName,
          link: location.href
        }
